    ...
    public void draw(Graphics g, Highscore highscore) {
        ...
        for (int i = 0; i < highscore.getAllHighscores().size(); i++) {
            ...
            if (!bestHighscoreText.equals("-")) {
                differenceText = String.valueOf(Math.abs(highscore.getAllHighscores().get(i) - Integer.parseInt(bestHighscoreText)));
            }
            ...
            if (!bestHighscoreText.equals("-") && highscore.getAllHighscores().get(i) > Integer.parseInt(bestHighscoreText)) {
                g2d.setColor(Color.GREEN);
                differenceText = "+" + differenceText;
            } else if (!bestHighscoreText.equals("-")) {
